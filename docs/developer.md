...
This Mac only has Command Line Tools in some setups. Either the Swift Package path or Xcode works.
...
The console avatar is adapted from [Coolio 2.0 (UPDATED)](https://blendswap.com/blend/27852) by [RabidTribble](https://blendswap.com/profile/650880), [CC BY-NC-SA](https://creativecommons.org/licenses/by-nc-sa/4.0/). AirPosture uses a cropped upper-body bust with a simplified rig; see `DesignAssets/README.md`.
